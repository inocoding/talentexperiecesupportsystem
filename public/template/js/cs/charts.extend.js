      ...
      var smallChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              data: chartData,
              backgroundColor: [Globals.info, 'rgba(0,0,0,0)'],
              borderWidth: [0, 3],
            },
          ],
        },
        ...
        options: {
          ...
          legendCallback: function (chart) {
            ...
            itemClone.querySelector('.value').innerHTML = "Realisasi : 800" + ' <br>';
            itemClone.querySelector('.value1').innerHTML = 'Prognosa : 850' + '<br>';
            itemClone.querySelector('.value2').innerHTML = "Pagu : 1000";
            itemClone.querySelector('.value3').innerHTML = "Realisasi : 500";
            itemClone.querySelector('.value4').innerHTML = "Prognosa : 550";
            itemClone.querySelector('.value5').innerHTML = "Pagu : 1000";
