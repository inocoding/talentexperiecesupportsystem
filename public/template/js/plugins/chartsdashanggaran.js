...
class Charts {
  ...
  _initEvents() {
    ...
    document.documentElement.addEventListener(Globals.colorAttributeChange, (event) => {
      ...
      this._lineChart5 && this._lineChart5.destroy();
      this._initLineChart5();
      ...
      this._smallLineChart5 && this._smallLineChart5.destroy();
      this._initSmallLineCharts();
    });
  }
    ...
    if (document.getElementById('lineChart')) {
      ...
      this._lineChart = new Chart(lineChart, {
            ...
            yAxes: [
              {
                ...
                ticks: {beginAtZero: true, stepSize: 50000, min: 0, max: 500000, padding: 20, fontColor: Globals.alternate},
              },
            ],
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Pagu 2025 (dalam Juta)',
              data: [458267, 458267, 458267, 458267, 458267, 458267, 458267, 458267, 458267, 458267, 458267, 458267],
            ...
            {
              label: 'Realisasi 2025 (dalam Juta)',
              data: [1569, 15879, 50140, 76258, 106684, 140301, 152981, 180939, 220693, 254327, , ],
      ...
      this._lineChart = new Chart(lineChart, {
        ...
        options: {
          ...
          scales: {
            yAxes: [
              {
                gridLines: {display: true, lineWidth: 1, color: Globals.separatorLight, drawBorder: false},
                ticks: {beginAtZero: true, stepSize: 1000, min: 0, max: 10000, padding: 20, fontColor: Globals.alternate},
              },
            ],
            xAxes: [{gridLines: {display: false}, ticks: {fontColor: Globals.alternate}}],
          },
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Pagu',
              data: [9776, 9776, 9776, 9776, 9776, 9776, 9776, 9776, 9776, 9776, 9776, 9776,],
              borderColor: Globals.secondary,
              pointBackgroundColor: Globals.secondary,
              pointBorderColor: Globals.secondary,
              pointHoverBackgroundColor: Globals.secondary,
            ...
            {
              label: 'Realisasi',
              data: [473, 1015, 1372, 2192, 2584, 3346, 4565, 6197, 8570, , , , ],
              borderColor: Globals.primary,
              pointBackgroundColor: Globals.primary,
              pointBorderColor: Globals.primary,
              pointHoverBackgroundColor: Globals.primary,
      ...
      this._lineChart = new Chart(lineChart, {
        ...
        options: {
          ...
          scales: {
            yAxes: [
              {
                gridLines: {display: true, lineWidth: 1, color: Globals.separatorLight, drawBorder: false},
                ticks: {beginAtZero: true, stepSize: 1500, min: 0, max: 15000, padding: 20, fontColor: Globals.alternate},
              },
            ],
            xAxes: [{gridLines: {display: false}, ticks: {fontColor: Globals.alternate}}],
          },
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Pagu (Rp Juta)',
              data: [12625, 12625, 12625, 12625, 12625, 12625, 12625, 12625, 12625, 12625, 12625, 12625,],
              borderColor: Globals.secondary,
              pointBackgroundColor: Globals.secondary,
              pointBorderColor: Globals.secondary,
              pointHoverBackgroundColor: Globals.secondary,
            ...
            },
            {
              ...
              data: [48, 525, 682, 725, 1020, 1101, 1698, 1898, 2124, ],
              borderColor: Globals.primary,
              pointBackgroundColor: Globals.primary,
              pointBorderColor: Globals.primary,
              pointHoverBackgroundColor: Globals.primary,
      ...
      this._lineChart = new Chart(lineChart, {
        ...
        options: {
          ...
          scales: {
            yAxes: [
              {
                gridLines: {display: true, lineWidth: 1, color: Globals.separatorLight, drawBorder: false},
                ticks: {beginAtZero: true, stepSize: 36000, min: 0, max: 360000, padding: 20, fontColor: Globals.alternate},
              },
            ],
            xAxes: [{gridLines: {display: false}, ticks: {fontColor: Globals.alternate}}],
          },
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Pagu (Rp Juta)',
              data: [357543, 357543, 357543, 357543, 357543, 357543, 357543, 357543, 357543, 357543, 357543, 357543,],
              borderColor: Globals.secondary,
              pointBackgroundColor: Globals.secondary,
              pointBorderColor: Globals.secondary,
              pointHoverBackgroundColor: Globals.secondary,
            ...
            {
              label: 'Realisasi (Rp Juta)',
              data: [354, 13392, 46228, 70362, 95695, 124559, 129517, 152622, 186410, ],
              borderColor: Globals.primary,
              pointBackgroundColor: Globals.primary,
              pointBorderColor: Globals.primary,
              pointHoverBackgroundColor: Globals.primary,
...
_initLineChart5() {
    if (document.getElementById('lineChart5')) {
      const lineChart = document.getElementById('lineChart5').getContext('2d');
      this._lineChart = new Chart(lineChart, {
        type: 'line',
        options: {
          plugins: {
          ...
          scales: {
            yAxes: [
              {
                gridLines: {display: true, lineWidth: 1, color: Globals.separatorLight, drawBorder: false},
                ticks: {beginAtZero: true, stepSize: 8000, min: 0, max: 80000, padding: 20, fontColor: Globals.alternate},
              },
            ],
            xAxes: [{gridLines: {display: false}, ticks: {fontColor: Globals.alternate}}],
          },
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Pagu (Rp Juta)',
              data: [78321, 78321, 78321, 78321, 78321, 78321, 78321, 78321, 78321, 78321, 78321, 78321],
              borderColor: Globals.secondary,
              pointBackgroundColor: Globals.secondary,
              pointBorderColor: Globals.secondary,
              pointHoverBackgroundColor: Globals.secondary,
            ...
            {
              label: 'Realisasi (Rp Juta)',
              data: [692, 947, 1857, 2977, 7385, 11294, 17200, 20220, 23587],
              borderColor: Globals.primary,
              pointBackgroundColor: Globals.primary,
              pointBorderColor: Globals.primary,
              pointHoverBackgroundColor: Globals.primary,
