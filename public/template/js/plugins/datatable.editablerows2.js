 ...
 class EditableRows2 {
    ...
    _createInstance() {
      ...
      this._datatable = jQuery('#datatableRows').DataTable({
        ...
        pageLength: 5,
        columns: [{data: 'no'}, {data: 'Unit Induk'}, {data: 'JTM'}, {data: 'JTR'}, {data: 'Gardu Distribusi'}, {data: 'Rumah Tangga'}, {data: 'Bisnis'}, {data: 'Industri'}, {data: 'Sosial'}, {data: 'Ged. Pemerintahan'}, {data: 'PJU'} ],
        language: {
          paginate: {
