 ...
 class EditableRows {
  ...
  _createInstance() {
    ...
    this._datatable = jQuery('#datatableRows').DataTable({
      ...
      pageLength: 15,
      columns: [{data: 'no'}, {data: 'no test'}, {data: 'nama'}, {data: 'jenjang'}, {data: 'proyeksi jabatan'}, {data: 'unit proyeksi 1'}, {data: 'unit proyeksi 2'}, {data: 'unit proyeksi 3'}, {data: 'unit proyeksi 4'}, {data: 'tanggal mulai ojt'}, {data: 'tanggal selesai ojt'} ],
      language: {
        paginate: false,
      },
