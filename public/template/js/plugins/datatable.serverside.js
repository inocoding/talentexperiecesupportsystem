...
class RowsServerSide {
  constructor() {
    ...
    this._apiPath = "app/models/rsertifikasi/getAll";
  ...
  _createInstance() {
    ...
    this._datatable = jQuery('#datatableRowsServerSide').DataTable({
      ...
      pageLength: 10,
      columns: [{data: 'user_id'}, {data: 'nip'}, {data: 'nama_user'}, {data: 'email_korpo'}, {data: 'Tag'}, {data: 'email'}, {data: 'activation'}, {data: 'Check'} ],
      language: {
        paginate: {
