...
class EditableRows {
    ...
    _createInstance() {
      ...
      this._datatable = jQuery('#datatableRowsdeval').DataTable({
        ...
        pageLength: 10,
        columns: [{data: 'no'}, {data: 'Nomor Surat/ND'}, {data: 'Dari'}, {data: 'Jml Usulan/Kebutuhan'}, {data: 'Eval PIC'}, {data: 'Eval MSB'}, {data: 'Eval VP'}, {data: 'Lanjut'}, {data: 'Tdk Lanjut'}, {data: 'Jawaban'}, {data: 'Konfirmasi'}, {data: 'Balasan Konfirmasi'}, {data: 'Cetak SK'}, {data: 'Action'}],
        language: {
            paginate: {
    ...
    _createInstance2() {
        ...
        this._datatable = jQuery('#datatableRows').DataTable({
          ...
          sDom: '<"row"<"col-sm-12"<"table-container"t>r>><"row"<"col-12"p>>', // Hiding all other dom elements except table and pagination
          pageLength: 5,
          columns: [{data: 'no'}, {data: 'Unit Induk'}, {data: 'JTM'}, {data: 'JTR'}, {data: 'Gardu Distribusi'}, {data: 'Rumah Tangga'}, {data: 'Bisnis'}, {data: 'Industri'} ],
          language: {
              paginate: {
                previous: '<i class="cs-chevron-left"></i>',
                next: '<i class="cs-chevron-right"></i>',
