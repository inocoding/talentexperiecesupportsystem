 ...
 */
 ...
 class EditableRows {
    ...
    _createInstance() {
      const _this = this;
      this._datatable = jQuery('#datatableRows3').DataTable({
        scrollX: true,
        ...
        pageLength: 5,
        columns: [ {data: 'no'}, {data: 'kode_nip'}, {data: 'nama_user'}, {data: 'nama_formasi_jabatan'}, {data: 'nama_riwayat_profesi'}, {data: 'jenjang_jabatan'}, {data: 'kode_riwayat_org_htd'}, {data: 'kode_riwayat_org_satu'}, {data: 'kode_riwayat_org_dua'}, {data: 'kode_riwayat_org_tiga'}, {data: 'start_date'}, {data: 'end_date'}, {data: 'action'} ],
        language: {
          paginate: false,
        },
