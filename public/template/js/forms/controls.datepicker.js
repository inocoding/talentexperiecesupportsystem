...
class DatePickerControls {
  ...
  _initFormat2() {
    jQuery('#datePickerFormat2').datepicker({
      format: 'yyyy-mm-dd',
      autoclose: true,
    });
  }
  ...
  _initFormat3() {
    jQuery('#datePickerFormat3').datepicker({
      format: 'yyyy-mm-dd',
      autoclose: true,
    });
  }
  _initFormat4() {
    jQuery('#datePickerFormat4').datepicker({
      format: 'yyyy-mm-dd',
      autoclose: true,
    });
  }
  _initFormat5() {
    jQuery('#datePickerFormat5').datepicker({
      format: 'yyyy-mm-dd',
      autoclose: true,
    });
  }
  _initFormat6() {
    jQuery('#datePickerFormat6').datepicker({
      format: 'yyyy-mm-dd',
      autoclose: true,
    });
  }
