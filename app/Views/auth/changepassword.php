...
<head>
    ...
    <title>Change Password | HTD 4</title>
                    ...
                    <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
                        <div class="sw-lg-50 px-5">
                            ...
                            <div class="mb-5">
                                ...
                                <p class="h6"><?= session('reset_email') ?></p>
                            ...
                            <div>
                                ...
                                <form class="tooltip-end-bottom" method="POST" action="<?= site_url('auth/changePassword') ?>">
                                    <?= csrf_field() ?>
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        <i data-cs-icon="lock-off"></i>
                                        <input class="form-control" placeholder="New Password" name="password" id="rulesPassword" type="password" />
                                    </div>
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        <i data-cs-icon="lock-on"></i>
                                        <input class="form-control" placeholder="Confirm New Password" name="confirmpassword" id="rulesPasswordConfirm" type="password" />
                                    </div>
                                    <div class="row">
                                        <div class="col">
