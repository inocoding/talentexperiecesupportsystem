...
<head>
    ...
    <title>Forgot Password Akun Sinergi | HTD 4</title>
                    ...
                    <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
                        <div class="sw-lg-50 px-5">
                            ...
                            <div>
                                ...
                                <?php endif; ?>
                                <form class="tooltip-end-bottom" method="POST" action="<?= site_url('auth/prosesforgot') ?>" novalidate>
                                    <?= csrf_field() ?>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-primary" style="float: right;">Reset Password</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
