...
<?= $this->section('title') ?>
<title>Data Org Kantor Pusat Level 2</title>
<?= $this->endSection() ?>
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h2 class="mb-0 pb-0" id="title">Master Data Organisasi Kantor Pusat Level #2</h2>
                </div>
                <!-- Title End -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                        <div class="d-inline-block">
                            <!-- Print Button Start -->
                            <a href="<?= site_url('masterdata/dataorgkpdua') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Upload Data Organisasi KP Level #2" type="button">
                ...
                <table id="datatableRows" class="data-table nowrap hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">Singkatan</th>
                    ...
                    <tbody>
                        ...
                        foreach ($rows as $key => $value) : ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $value->kode_org_kp_dua ?></td>
                                <td><?= $value->nama_org_kp_dua ?></td>
                                <td><?= $value->singkatan_kp_dua ?></td>
                                <td><?= $value->singkatan_kp_satu ?></td>
                                <td>
                                    <div class="d-inline-block">
...
<script src="<?= base_url() ?>/template/js/plugins/datatable.editablerowsorgkpdua.js"></script>
