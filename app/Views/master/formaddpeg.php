...
<?= $this->section('title') ?>
<title>Tambah Data Pegawai - HTD 4</title>
<?= $this->endSection() ?>
...
<div class="row">
    <div class="col">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h1 class="mb-0 pb-0 display-4" id="title">Tambah Data Pegawai</h1>
                </div>
                <!-- Title End -->
            </div>
        </div>
        ...
        <section class="scroll-section" id="contact">
            ...
            <form class="card mb-5 tooltip-end-top" action="<?= site_url('masterdata/addpeg') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="card-body" id="contactForm">
                    ...
                    <div class="mb-3 filled">
                        ...
                        <input class="form-control" placeholder="Nama Pegawai" name="nama_user" />
                    </div>
                    <div class="mb-3 filled">
                        <i data-cs-icon="calendar"></i>
                        <input class="form-control" placeholder="Tanggal Lahir" name="tgl_lahir" id="datePickerFormat" />
                    </div>
                    <div class="input-group mb-3 filled">
                        <i data-cs-icon="email"></i>
                        <input type="text" class="form-control" placeholder="Email Corporate" name="email_korpo" aria-describedby="basic-addon2" />
                        <span class="input-group-text" id="basic-addon2">@pln.co.id</span>
                    </div>
                    <div class="mb-3 filled">
                        <i data-cs-icon="mobile"></i>
                        <input class="form-control" placeholder="No Handphone" type="text" name="no_hp" />
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch justify-content-center">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="role_komite" value="1" />
                    ...
                    <div class="row g-2 d-flex justify-content-center mb-3">
                        <div class="col-2">
                            <label class="form-check custom-card w-100 position-relative p-0 m-0">
                                <input type="radio" class="form-check-input position-absolute e-2 t-2 z-index-1" name="role_htd" value="4" />
                        ...
                        <div class="col-2">
                            <label class="form-check custom-card w-100 position-relative p-0 m-0">
                                <input type="radio" class="form-check-input position-absolute e-2 t-2 z-index-1" name="role_htd" value="0" />
                                <span class="card form-check-label w-100 custom-border">
                                    <span class="card-body text-center">
                                        <i data-cs-icon="user" class="text-primary"></i>
                        ...
                        <div class="col-2">
                            <label class="form-check custom-card w-100 position-relative p-0 m-0">
                                <input type="radio" class="form-check-input position-absolute e-2 t-2 z-index-1" name="role_htd" value="3" />
                                <span class="card form-check-label w-100 custom-border">
                                    <span class="card-body text-center">
                                        <i data-cs-icon="user" class="text-primary"></i>
                        ...
                        <div class="col-2">
                            <label class="form-check custom-card w-100 position-relative p-0 m-0">
                                <input type="radio" class="form-check-input position-absolute e-2 t-2 z-index-1" name="role_htd" value="2" />
                                <span class="card form-check-label w-100 custom-border">
                                    <span class="card-body text-center">
                                        <i data-cs-icon="user" class="text-primary"></i>
                        ...
                        <div class="col-2">
                            <label class="form-check custom-card w-100 position-relative p-0 m-0">
                                <input type="radio" class="form-check-input position-absolute e-2 t-2 z-index-1" name="role_htd" value="1" />
                                <span class="card form-check-label w-100 custom-border">
                                    <span class="card-body text-center">
                                        <i data-cs-icon="user" class="text-primary"></i>
                    ...
                    <div class="mb-3 filled w-100">
                        ...
                        <div class="d-flex justify-content-evenly">
                            <input type="checkbox" class="btn-check" id="btnCheckPrimaryOutline" name="role_admin" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckPrimaryOutline">Admin Suksesi</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline" name="role_adm_acc" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline">Admin ACCESS</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline2" name="role_adm_eclinic" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline2">Admin E-Clinic</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline3" name="role_adm_hi" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline3">Admin HI</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline4" name="role_adm_org" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline4">Admin Organisasi</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline5" name="role_adm_kinerja" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline5">Admin Kinerja</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline6" name="role_adm_diklat" value="1" />
                            <label class="btn btn-outline-primary" for="btnCheckSecondaryOutline6">Admin Diklat</label>
                            <input type="checkbox" class="btn-check" id="btnCheckSecondaryOutline7" name="role_adm_sertifikasi" value="1" />
