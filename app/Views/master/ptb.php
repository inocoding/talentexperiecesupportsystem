        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h2 class="mb-0 pb-0" id="title">Master Data PTB <?= userLogin()->nama_org_htd ?></h2>
                </div>
                <!-- Title End -->
                ...
                <table id="datatableRows" class="data-table nowrap hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">Unit Asal Lv1</th>
                            <th class="text-muted text-small text-uppercase">Unit Asal Lv2</th>
                            <th class="text-muted text-small text-uppercase">Unit Asal Lv3</th>
                            <th class="text-muted text-small text-uppercase">Angkatan</th>
                            <th class="text-muted text-small text-uppercase">Jenjang PTB</th>
                            <th class="text-muted text-small text-uppercase">Program Pendidikan Formal</th>
                            <th class="text-muted text-small text-uppercase">Bidang</th>
                            <th class="text-muted text-small text-uppercase">Sub Bidang</th>
                            <th class="text-muted text-small text-uppercase">On Mission</th>
                            <th class="text-muted text-small text-uppercase">Program Studi</th>
                            <th class="text-muted text-small text-uppercase">Universitas</th>
                            <th class="text-muted text-small text-uppercase">Tgl Mulai Studi</th>
                            <th class="text-muted text-small text-uppercase">Tgl Selesai Studi</th>
                            <th class="text-muted text-small text-uppercase">STatus</th>
                            <th class="text-muted text-small text-uppercase">Penempatan Pasca Studi</th>
                            <th class="text-muted text-small text-uppercase">Unit Penempatan Lv1</th>
                            <th class="text-muted text-small text-uppercase">Unit Penempatan Lv2</th>
                            <th class="text-muted text-small text-uppercase">Unit Penempatan Lv3</th>
                            <th class="text-muted text-small text-uppercase">Tgl Aktivasi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        foreach ($user as $key => $value) : ?>
                            <tr>
                                ...
                                <td><?= $value->jenjang_ptb ?></td>
                                <td><?= $value->program_pendidikan_formal ?></td>
                                <td><?= $value->bidang ?></td>
                                <td><?= $value->sub_bidang ?></td>
                                <td><?= $value->on_mission ?></td>
                                <td><?= $value->program_studi ?></td>
                                <td><?= $value->universitas ?> <br>
                                <td><?= $value->tgl_mulai_studi ?> <br>
                                <td><?= $value->tgl_selesai_studi ?> <br>
                                <td><?= $value->penempatan_pasca_studi ?></td>
                                <td><?= $value->unit_penempatan_lv1 ?></td>
                                <td><?= $value->unit_penempatan_lv2 ?></td>
                                <td><?= $value->unit_penempatan_lv3 ?></td>
                                <td><?= $value->tanggal_aktivasi ?></td>
