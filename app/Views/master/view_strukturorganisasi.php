...
<?= $this->section('title') ?>
<title>Data Struktur Organisasi<?= userLogin()->nama_org_htd ?></title>
<?= $this->endSection() ?>
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h2 class="mb-0 pb-0" id="title">Master Data Struktur Organisasi</h2>
                </div>
                <!-- Title End -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                        ...
                        <div class="d-inline-block">
                            <!-- Print Button Start -->
                            <a href="<?= site_url('masterdata/addstrukturorganisasi') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Upload Data Struktur Organisasi" type="button">
                            ...
                            <div class="d-inline-block datatable-export" data-datatable="#datatableRows">
                                ...
                                ?>
                                <a class="btn p-0" href="<?= site_url('masterdata/exportstrukturorganisasai' . $param) ?>" data-bs-offset="0,3">
                ...
                <table id="datatableRows" class="data-table nowrap hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">kode_posisi</th>
                            <th class="text-muted text-small text-uppercase">nama_fj</th>
                            <th class="text-muted text-small text-uppercase">jenjang</th>
                            <th class="text-muted text-small text-uppercase">org_unit</th>
                            <th class="text-muted text-small text-uppercase">company_code</th>
                            <th class="text-muted text-small text-uppercase">personel_area</th>
                            <th class="text-muted text-small text-uppercase">personel_sub_srea</th>
                            <th class="text-muted text-small text-uppercase">tx_org_satu</th>
                            <th class="text-muted text-small text-uppercase">tx_org_dua</th>
                            <th class="text-muted text-small text-uppercase">tx_org_tiga</th>
                            <th class="text-muted text-small text-uppercase">kode_org_satu</th>
                            <th class="text-muted text-small text-uppercase">kode_org_dua</th>
                            <th class="text-muted text-small text-uppercase">kode_org_tiga</th>
                    ...
                    <tbody>
                        ...
                        foreach ($user as $key => $value) : ?>
                            <tr>
                                ...
                                <td><?= $no++ ?></td>
                                <td><?= $value->kode_posisi ?></td>
                                <td><?= $value->nama_fj ?></td>
                                <td><?= $value->jenjang ?></td>
                                <td><?= $value->org_unit ?> </td>
                                <td> <?= $value->company_code ?></td>
                                <td> <?= $value->personel_area ?></td>
                                <td> <?= $value->personel_sub_srea ?></td>
                                <td> <?= $value->tx_org_satu ?></td>
                                <td> <?= $value->tx_org_dua ?></td>
                                <td> <?= $value->tx_org_tiga ?></td>
