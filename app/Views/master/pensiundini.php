        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h2 class="mb-0 pb-0" id="title">Master Data Pensiun Dini lho</h2>
                </div>
                <!-- Title End -->
                ...
                <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    ...
                    <!-- <a href=" <?= site_url('masterdata/pensiundini') ?> " type="button" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-dapeg">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                        <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                            <!-- Add Button Start -->
                            <a href="<?= site_url('masterdata/addsert') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate shadow add-dapeg" data-bs-toggle="tooltip" data-bs-placement="top" title="Add data" type="button" data-bs-delay="0">
                                <i data-cs-icon="plus"></i>
                            </a>
                            <!-- Add Button End -->
                        ...
                        <div class="d-inline-block">
                            <!-- Print Button Start -->
                            <!-- <a href="<?= site_url('masterdata/import') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Upload Data" type="button">
                ...
                <table id="datatableRows" class="data-table nowrap hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">Unit Asal 1</th>
                            <th class="text-muted text-small text-uppercase">Unit Asal 2</th>
                            <th class="text-muted text-small text-uppercase">Unit Asal 3</th>
                            <th class="text-muted text-small text-uppercase">Unit Asal 4</th>
                    ...
                    <tbody>
                        ...
                        foreach ($rsert as $key => $value) : ?>
                            <tr>
                                ...
                                <td><?= $value->lsk ?></td>
                                <td> <a href="http://" rel="noopener noreferrer"></a>
                                    <?php
                                    if ($value->doc_sertifikat != NULL) {
                                        echo '<a href="' . base_url() . '/template/files/sertifikat/' . $value->doc_sertifikat . '" target="_blank" >' . $value->no_sertifikat . '</a>';
                                    } else {
                                        echo $value->no_sertifikat;
                                    }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <div class="d-inline-block">
                                        ...
                                        <form action="<?= site_url('masterdata/del_sertifikasi/' . $value->id_riwayat_sertifikasi) ?>" method="post" class="d-inline">
                                            <?= csrf_field() ?>
...
<script src="<?= base_url() ?>/template/js/plugins/datatable.editablerowssert.js"></script>
<!-- <script src="<?= base_url() ?>/template/js/plugins/datatable.serverside.js"></script> -->
