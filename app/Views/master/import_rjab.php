...
<?= $this->section('title') ?>
<title>Import Data Riwayat Jabatan - HTD 4</title>
<?= $this->endSection() ?>
...
<div class="row">
    <div class="col">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <h1 class="mb-0 pb-0 display-4" id="title">Import Data Riwayat Jabatan</h1>
                </div>
                <!-- Title End -->
            </div>
        </div>
        ...
        <section class="scroll-section" id="contact">
            <div class="row">
                <div class="col mb-1">
                    <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                        <!-- Back Button Start -->
                        <a href="<?= site_url('masterdata/rjab') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate shadow add-dapeg" data-bs-toggle="tooltip" data-bs-placement="top" title="Back" type="button" data-bs-delay="0">
            ...
            <?php endif; ?>
            <form class="card mb-5 tooltip-end-top" action="<?= site_url('masterdata/prosesimport_rjab') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <a href="<?= base_url('template/files/template_import_rjab.xlsx') ?>" data-target="_blank" class="btn btn-icon btn-icon-end btn-secondary">
