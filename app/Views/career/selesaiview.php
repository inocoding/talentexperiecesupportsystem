...
<section class="scroll-section" id="formRow">
    ...
    <?php endif; ?>
    <div class="btn-group">
        <a href="<?= site_url('career/selesaieval') ?>" class="btn-link">
                ...
                <div class="">
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-1">
                                <label for="inputEmail4" class="form-label">Evaluating</label>
                    ...
                    <div class="card-body" style="margin-top: -20px;">
                        <div class="row">
                            ...
                            <div class="col-12 mt-1 mb-1">
                                <label for="inputCity" class="form-label">Dahan Profesi Jabatan Saat Ini</label>
                            ...
                            <div class="col-md-12 mt-1 mb-1">
                                <label for="inputCity" class="form-label">Jarak Antar Unit (KM) </label>
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-1">
                                <label for="inputCity" class="form-label">FTK Unit Tujuan</label>
                                ...
                                <input type="hidden" class="form-control" name="timestapm_entry" value="<?= time() ?>" />
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getRekan() {
                ...
                const a = $('#masaKerja').val();
                const b = hitungtahun(a);
                $('#masaKerja').val(b[0] + ' tahun ' + b[1] + ' bulan');
