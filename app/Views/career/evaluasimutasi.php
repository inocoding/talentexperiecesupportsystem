                                ...
                                <table id="datatableRows" class="data-table nowrap hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-muted text-small text-uppercase text-wrap" style="width: 5rem;">Asal</th>
                                            <th class="text-muted text-small text-uppercase text-wrap" style="width: 5rem;">Tujuan</th>
                                    ...
                                    <tbody style="font-size: smaller;">
                                        ...
                                        foreach ($user as $key => $value) : ?>
                                            <tr>
                                                ...
                                                <td class="text-wrap text-break" style="width: 7rem;"><?= $value->unit_asal ?></td>
                                                <td class="text-wrap text-break" style="width: 7rem;">
                                                    <?php
                                                ...
                                                <td><span class="badge bg-primary"><?= substr(explode(' ', $value->nama_user)[0], 0, 1) ?><?= substr(explode(' ', $value->nama_user)[1], 0, 1) ?></span></td>
                                                <td>
                                                    <div class="d-inline-block text-center">
                                                        ...
                                                        <a href="<?= site_url('career/hitungsla/' . $value->id_eval . '/1') ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate " data-bs-toggle="tooltip" data-bs-placement="top" title="evaluasi">
