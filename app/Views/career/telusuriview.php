...
<?= $this->section('title') ?>
<title><?= $dataeval->id_eval ?> - <?= $dataeval->nama_eval ?></title>
<?= $this->endSection() ?>
...
<section class="scroll-section" id="formRow">
    ...
    <?php endif; ?>
    <div class="btn-group">
        <a href="<?= site_url('career/telusurieval') ?>" class="btn-link">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select noDasarMutasi" id="select2Basic6" name="id_dasar_mutasi" aria-label="Example select with button addon" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                        <option selected></option>
                                        <?php foreach ($dm as $key => $value) : ?>
                                            <option class="text-muted" value="<?= $value->id_dm ?>" <?= $dataeval->id_dasar_mutasi == $value->id_dm ? "selected" : null ?>><?= $value->no_dm ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#semiFullExample" style="border-radius: 10px; width:10px; margin-left:2px;" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                            ...
                            <div class="col-md-3 mt-1">
                                ...
                                <select id="select2Basic8" onkeyup="kapital()" name="jenis_mutasi" class="w-100 form-control" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                    <option label="&nbsp;"></option>
                            ...
                            <div class="col-3 mt-1">
                                ...
                                <input type="text" class="form-control" id="inputAddress2" name="alasan_mutasi" value="<?= $dataeval->alasan_mutasi ?>" <?= $dataeval->hasil_evaluasi_3 != null ? "readonly" : null ?> readonly />
                            </div>
                            <div class="col-md-3 mt-1">
                    ...
                    <div class="card-body" style="margin-top: -20px;">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="" class="form-control nipToEval" name="kode_nip" value="<?= $dataeval->nip_eval ?>" onkeyup="kapital()" <?= $dataeval->hasil_evaluasi_3 != null ? "readonly" : null ?> readonly />
                            </div>
                            <div class="col-12 mt-1 mb-1">
                                ...
                                <select id="select2Basic4" onkeyup="kapital()" name="dahan_profesi_skrg" class="w-100" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                    <option label="&nbsp;"></option>
                            ...
                            <div class="col-md-12 mt-1 mb-1">
                                ...
                                <input type="" class="form-control" id="inputftkupsupasal" name="ftkupsupasal" value="<?= $dataeval->ftkupsupasal ?>" readonly />
                            ...
                            <div class="col-12 mt-1 mb-1">
                                ...
                                <select id="select2Basic2" onkeyup="kapital()" name="unit_tujuan" class="w-100 form-control proyeksi-unit" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                    <option label="&nbsp;"></option>
                            ...
                            <div class="col-12 mt-1 mb-1 <?= $dataeval->div_tujuan == null ? "d-none" : null ?> " id="boxDivTujuan">
                                ...
                                <select id="select2Basic3" onkeyup="kapital()" name="div_tujuan" class="w-100 form-control divisi-tujuan" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                    <option label="&nbsp;"></option>
                            ...
                            <div class="col-12 mt-1 mb-1 <?= $dataeval->org_dua_tujuan == null ? "d-none" : null ?> " id="boxOrgDuaTujuan">
                                ...
                                <select id="select2Basic14" onkeyup="kapital()" name="org_dua_tujuan" class="w-100 form-control unitPelaksana" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                            ...
                            <div class="col-12 mt-1 mb-1 <?= $dataeval->org_tiga_tujuan == null ? "d-none" : null ?> " id="boxOrgTigaTujuan">
                                ...
                                <select id="select2Basic13" onkeyup="kapital()" name="org_tiga_tujuan" class="w-100 form-control divisi-tujuan" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                            ...
                            <div class="col-md-12 mt-1 mb-1">
                                ...
                                <input type="" class="form-control" id="inputftkupsup" name="ftkupsup" value="<?= $dataeval->ftkupsup ?>" readonly />
                                <span class="text-muted" id="" style="font-size: smaller;">pemisah desimal menggunakan tanda titik (*bila ada)</span>
                            </div>
                            <div class="col-md-12 mt-1 mb-1">
                                <label for="inputCity" class="form-label">
                                ...
                                <input type="" class="form-control" id="jarakUnit" name="jarak_antar_unit" value="<?= $dataeval->jarak_antar_unit ?>" readonly />
                            ...
                            <div class="col-12 mt-1 mb-1">
                                ...
                                <select id="select2Basic5" onkeyup="kapital()" name="dahan_profesi_tujuan" class="w-100" <?= $dataeval->hasil_evaluasi_3 != null ? "disabled" : null ?> disabled>
                                    <option label="&nbsp;"></option>
                                    <?php foreach ($profesi as $key => $value) : ?>
                            ...
                            <div class="col-md-12 mt-1 mb-1">
                                ...
                                <input type="" class="form-control" id="kodeOrgTujuan" name="kode_org_unit_tujuan" value="<?= $dataeval->kode_org_unit_tujuan ?>" readonly />
                                <span class="text-muted" id="" style="font-size: smaller;"></span>
                            </div>
                            <div class="col-md-12 mt-1 mb-1">
                                <label for="inputCity" class="form-label">PoG Jabatan Tujuan</label>
                                <input type="" class="form-control" id="pogBaru" name="pog_baru" value="<?= $dataeval->pog_baru ?>" onkeyup="kapital()" <?= $dataeval->hasil_evaluasi_3 != null ? "readonly" : null ?> readonly />
                            </div>
                            <div class="col-md-12 mt-1 mb-1">
                                <label for="inputCity" class="form-label">Proyeksi Jabatan Tujuan (Lengkap)</label>
                                <textarea type="text" class="form-control" id="inputCity" name="proyeksi_jabatan_baru" rows="5" <?= $dataeval->hasil_evaluasi_3 != null ? "readonly" : null ?> readonly><?= $dataeval->proyeksi_jabatan_baru ?></textarea>
                            </div>

                            <hr class="mt-4">
                            <?php
                            if ($dataeval->hasil_evaluasi_3 >= 0) {
                            } else {
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-1">
                                ...
                                <input type="text" class="form-control" id="masaKerja" value="<?= $dataeval->masa_kerja ?>" readonly />
                                <input type="hidden" class="form-control" id="masaKerja2" name="masa_kerja" value="<?= $dataeval->masa_kerja ?>" readonly />
                                    ...
                                    <table class="table table-sm table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <?= $dataeval->hasil_evaluasi_3 == null ? null : 'GREGORIUS HELMY WIDYAPAMUNGKAS' ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>NIP</td>
                                                <td>:</td>
                                                <td><?= $dataeval->hasil_evaluasi_3 == null ? null : $dataeval->pemeriksa_2 ?></td>
                                            </tr>
                                            <tr>
                                                <td>Tgl Submit</td>
                                                <td>:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <strong class="<?= $dataeval->hasil_evaluasi_3 == null ? 'd-none' : null ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <strong class="<?= $dataeval->hasil_evaluasi_3 == null ? 'd-none' : null ?>">
                                                        <?= $dataeval->hasil_evaluasi_3 == 1 ? "Proses Jawaban & Konfirmasi" : "Proses Jawaban" ?>
                                                    </strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table table-sm table-borderless">
                                        <tbody>
                                            <tr>
                                                <td>Nama</td>
                                                <td>:</td>
                                                <td class="<?= $dataeval->hasil_evaluasi_2 == null ? 'd-none' : null ?>">
                                            ...
                                            <tr>
                                                <td>NIP</td>
                                                <td>:</td>
                                                <td class="<?= $dataeval->hasil_evaluasi_2 == null ? 'd-none' : null ?>"><?= $dataeval->pemeriksa_1 ?></td>
                                            </tr>
                                            <tr>
                                                <td>Tgl Submit</td>
                                                <td>:</td>
                                                <td class="<?= $dataeval->hasil_evaluasi_2 == null ? 'd-none' : null ?>"><?= $dataeval->tgl_submit_eval_2 ?></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Rekomendasi</strong></td>
                                                <td>:</td>
                                                <td>
                                                    <strong class="<?= $dataeval->hasil_evaluasi_2 == null ? 'd-none' : null ?>">
            ...
            <div class="card mb-3">
                <div class="card-header border-0 pb-0">
                    <ul class="nav nav-tabs nav-tabs-line card-header-tabs responsive-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?= $dataeval->hasil_evaluasi_akhir == 0 ? "disabled" : null ?>" data-bs-toggle="tab" data-bs-target="#fourth4" role="tab" type="button" aria-selected="false">
                                SK
                            </button>
                        </li>
                        <!-- An empty list to put overflowed links -->
                                    ...
                                    <table class="table table-sm table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><u><a href="<?= base_url('template/files/dm/' . $dataeval->lampiran_jwbn) ?>" target="_blank" rel="noopener noreferrer"><?= $dataeval->nd_jwbn_1_to_requestr ?></a></u></td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal ND</td>
                                                <td>:</td>
                        ...
                        <div class="tab-pane fade" id="second2111" role="tabpanel">
                            ...
                            <form action="<?= site_url('career/addbalasan/' . $uri->getSegment(3)) ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="inputPassword4" class="form-label">Tanggal ND</label>
                                        <input name="tgl_konfirm" class="form-control" id="datePickerFormat4" />
                                    </div>
                                    <div class="col-md-3">
                                        <label for="inputAddress2" class="form-label mt-2">Nomor ND</label>
                ...
                <form action="">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="inputPassword4" class="form-label">Jenis</label>
                                <input class="form-control" id="jenis_dm_detail" value="
                                <?php
