                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-inline-block text-center">
                                                        <a href="<?= site_url('career/editkonsep/' . $value->id_eval) ?>" class="btn btn-icon btn-icon-only btn-foreground-alternate " data-bs-toggle="tooltip" data-bs-placement="top" title="evaluasi">
                                                            <i data-cs-icon="edit"></i>
                                                        </a>
                                                        <form action="<?= site_url('career/del_konsep/' . $value->id_eval) ?>" method="post" class="d-inline">
                                                            <?= csrf_field() ?>
